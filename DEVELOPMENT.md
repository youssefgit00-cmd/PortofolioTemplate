...
```bash
git clone https://github.com/youssefkandeel/youssefkandeel.com.git minimal-dev-portfolio
...
The application should now be available at https://youssefkandeel.localhost
...
If you're working on a different React project and want to reuse the custom components from this repository, visit [youssefkandeel.com/components](https://youssefkandeel.com/components) for installation instructions and component documentation.
...
```bash
pnpm capture       # Capture screenshots into .youssefkandeel/screenshots
