...
const OPENPANEL_URL =
  "https://openpanel.dev?utm_source=youssefkandeel.com&utm_medium=referral&utm_campaign=footer"

// Not derived from `SITE_INFO.url`: that follows `NEXT_PUBLIC_APP_URL` and
// would read `youssefkandeel.localhost` in dev.
const SITE_TITLE = "youssefkandeel.com"
