...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/fluid-gradient-text.json"
  customizeUrl="https://youssefkandeel.com/preview/fluid-gradient-text-dialkit"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/fluid-gradient-text
```
