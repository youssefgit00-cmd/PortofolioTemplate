...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/github-stars.json"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/github-stars
```
...
```tsx
<GithubStars repo="youssefkandeel/youssefkandeel.com" stargazersCount={2050} />
```
