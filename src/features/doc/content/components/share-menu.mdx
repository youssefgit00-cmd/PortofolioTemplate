...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/share-menu.json"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/share-menu
```
...
```tsx
<ShareMenu title="youssefkandeel.com" url="https://youssefkandeel.com" />
```
