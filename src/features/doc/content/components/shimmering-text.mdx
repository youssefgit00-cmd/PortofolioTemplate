...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/shimmering-text.json"
...
<DocTestimonial
  ...
  quote="Using an adapted version of your Shimmer here @youssefkandeel"
  date="2026-06-01"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/shimmering-text
```
