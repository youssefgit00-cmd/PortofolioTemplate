...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/wheel-picker.json"
/>
...
<DocTestimonial
  ...
  quote="See @youssefkandeel Wheel Picker. It’s on the registry. Quick install."
  date="2026-05-22"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/wheel-picker
```
