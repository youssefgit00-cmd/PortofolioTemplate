...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/apple-hello-effect.json"
  canReplay
/>
...
```bash
npx shadcn@latest add @youssefkandeel/apple-hello-effect
```

For Hindi:

```bash
npx shadcn@latest add @youssefkandeel/apple-hello-effect-hindi
```

For Spanish:

```bash
npx shadcn@latest add @youssefkandeel/apple-hello-effect-spanish
```

For Vietnamese:

```bash
npx shadcn@latest add @youssefkandeel/apple-hello-effect-vietnamese
```
