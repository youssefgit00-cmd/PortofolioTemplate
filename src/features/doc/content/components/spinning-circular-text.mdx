...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/spinning-circular-text.json"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/spinning-circular-text
```
...
```tsx
<SpinningCircularText text="Built with care by youssefkandeel • " />
```
