...
```bash
npx shadcn@latest add @youssefkandeel/theme-toggle-effect-triangle
```

### Triangle blur

```bash
npx shadcn@latest add @youssefkandeel/theme-toggle-effect-triangle-blur
```

### Circle

```bash
npx shadcn@latest add @youssefkandeel/theme-toggle-effect-circle
```

### Circle blur

```bash
npx shadcn@latest add @youssefkandeel/theme-toggle-effect-circle-blur
```

### Circle blur (top left)

```bash
npx shadcn@latest add @youssefkandeel/theme-toggle-effect-circle-blur-top-left
```

### Polygon

```bash
npx shadcn@latest add @youssefkandeel/theme-toggle-effect-polygon
```

### Polygon gradient

```bash
npx shadcn@latest add @youssefkandeel/theme-toggle-effect-polygon-gradient
```
