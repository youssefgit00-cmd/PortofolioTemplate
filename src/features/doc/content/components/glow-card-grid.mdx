...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/glow-card-grid-demo.json"
  customizeUrl="https://youssefkandeel.com/preview/glow-card-grid-dialkit"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/glow-card-grid
```
