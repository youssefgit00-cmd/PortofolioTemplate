...
<ComponentPreview
  ...
  openInV0Url="https://youssefkandeel.com/r/code-block-command.json"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/code-block-command
```
...
- [Copy Button](https://youssefkandeel.com/components/copy-button)
