...
<ComponentPreview
  name="twemoji-demo"
  openInV0Url="https://youssefkandeel.com/r/twemoji.json"
/>
...
```bash
npx shadcn@latest add @youssefkandeel/twemoji
```
...
[lib/twemoji-regex.ts](https://github.com/youssefkandeel/youssefkandeel.com/blob/main/src/registry/components/twemoji/lib/twemoji-regex.ts)
