...
// TODO: The Daikanoid font, sound, and sprite assets are still served from the
// original author's CDN. They are game assets rather than branding, so they are
// left in place to keep the game playable — rehost them and swap these URLs.
