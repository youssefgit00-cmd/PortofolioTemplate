export const registryConfig = {
   ...
   * @example "@youssefkandeel" - Users can install components with: `npx shadcn add @youssefkandeel/wheel-picker`
   * @see https://ui.shadcn.com/docs/registry/namespace#overview
   */
  namespace: process.env.NEXT_PUBLIC_REGISTRY_NAMESPACE || "@youssefkandeel",
  /**
   * URL pattern for resolving namespaced components
   * The {name} placeholder will be replaced with the component name
   * @example "https://youssefkandeel.com/r/{name}.json" resolves to "https://youssefkandeel.com/r/wheel-picker.json"
  ...
  namespaceUrl:
    ...
    "https://youssefkandeel.com/r/{name}.json",
}
