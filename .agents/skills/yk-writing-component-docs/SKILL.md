---
name: youssefkandeel-writing-component-docs
...
image: https://assets.youssefkandeel.com/images/blog/{component-name}.webp
...
```typescript
{
  ...
  title: "Component Name",
  author: "youssefkandeel <dai@youssefkandeel.com>",
  // ...
}
```
